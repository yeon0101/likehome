...
<!-- 네비바 3차 -->
  <div class="scroll-container mt-1 py-2 text-center ">
	 ...
	 <div class="menu" onclick="location.href='customerMyAddressPage'">배송지관리</div>
  </div>
					...
					<c:choose>
                      ...
                      <div class="card-body pb-1">
                        ...
                        <c:if test="${orderDetail.orderDetailVo.order_detail_delivery_status == 2}">
                         <div class="row">
                           <div class="col d-grid"><button class="btn btn-main py-0 mb-2" data-bs-toggle="offcanvas" data-bs-target="#reviewForm" aria-controls="offcanvasRight">리뷰 작성</button></div>
                           <!-- 리뷰작성 offcanvas -->
                           <div class="offcanvas offcanvas-end" tabindex="-1" id="reviewForm" aria-labelledby="offcanvasRightLabel">
							  ...
							  <div class="offcanvas-body">
		                          ...
		                          <div class="col-4"><img src="../../uploadFiles/titleImage/${orderDetail.productTitleImageVo.title_image_link }" class="img-fluid rounded" alt="..."></div>
		                            ...
		                            <div class="row">
		                            	<div class="col p-price">
		                            		<span>${orderDetail.productVo.product_price}</span>
		                            	<span class="text-secondary"> | </span>${orderDetail.orderDetailVo.order_detail_quantity }개
		                            	</div>
		                            </div>
		                          </div>
		        				...
		        				<div class="row my-1 ">
		        					<div class="col review-title">별점 평가</div>
		        				</div>
		        				<div class="row my-1 ">
		        					<div class="col review-title">사진 업로드</div>
		        				</div>
		        				<div class="row my-1">
		        					<div class="col review-title">리뷰 작성</div>
		        				</div>
		        				<div class="row my-1">
		        					<div class="col">
		        						<div class="form-floating">
										  <textarea class="form-control" id="floatingTextarea2" style="height: 100px"></textarea>
										   <label for="floatingTextarea2">자세한 리뷰는 다른 고객에게 큰 도움이 됩니다.(최소 20자 이상)</label>
										</div>
		        					</div>
		        				</div>
