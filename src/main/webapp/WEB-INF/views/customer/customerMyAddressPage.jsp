...
<!-- 네비바 3차 -->
  <div class="scroll-container mt-1 py-2 text-center ">
	 ...
	 <div class="menu" style="color:#ff6500;" onclick="location.href='customerMyAddressPage'">배송지 관리</div>
  </div>
...
<div class="row my-2">
   <div class="col d-grid ps-0 pe-0" style="margin-left: 1em; margin-right: 1em;">
     <button class="btn" id="title">+ 배송지 추가</button>
   </div>
</div>
<div class="card" id="card">
  <div class="card-body" id="cardBody">
    <div class="row">
    	...
    	<div class="col mt-1 ps-0" style="color: #ff6500; font-size: 0.7em; margin-bottom: 0.5em;">
    		기본배송지
    	</div>
    </div>
    <div class="row">
    	<div class="col">
    		[07240] 서울시 강남구 테헤란로7길 7 00동 00호 
    	</div>
    </div>
    <div class="row">
    	<div id="phone" class="col-8">
    		010-1234-5678
    	</div>
    	<div class="col ps-0 pe-0">
    		<a href="./customerAddressWritePage"><button id="btn" type="button" class="btn">수정</button></a>
    		<button id="btn1" type="button" class="btn">삭제</button> 
    	</div>
    </div>
...
<div class="card" id="card">
  <div class="card-body" id="cardBody">
    ...
    <div class="row">
    	<div class="col">
    		[07280] 서울시 강동구 양재대로00길 00 00동 00호 
    	</div>
    </div>
    <div class="row">
    	<div id="phone" class="col-8">
    	...
    	<div class="col ps-0 pe-0">
    		<button id="btn" type="button" class="btn">수정</button>
    		<button id="btn1" type="button" class="btn">삭제</button> 
    	</div>
    </div>
  </div>
...
<div class="card" id="card">
  <div class="card-body" id="cardBody">
    ...
    <div class="row">
    	<div class="col">
    		[07280] 서울시 영등포구 선유로 00 현대아파트 00동 00호 
    	</div>
    </div>
    <div class="row">
    	<div id="phone" class="col-8">
