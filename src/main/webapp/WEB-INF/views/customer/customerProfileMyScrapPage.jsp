...
<!-- 네비바 3차 -->
  <div class="row text-center m-0 mt-1 py-2 justify-content-center" style="width:100%">
	 <div class="col-auto" onclick="location.href='../customer/customerProfileMyHomePage'">마이홈</div>
	 <div class="col-auto" onclick="location.href='../customer/customerProfileMyPhotoPage'">사진</div>
	 <div class="col-auto" style="color:#ff6500;" onclick="location.href='../customer/customerProfileMyScrapPage'">스크랩</div>
	 <div class="col-auto" onclick="location.href='../customer/customerProfileMyLikePage'">좋아요</div>
  </div>
