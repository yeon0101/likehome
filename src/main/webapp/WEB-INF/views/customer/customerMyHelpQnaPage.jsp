     ...
     <!-- 나의 문의 내역 -->
       <div class="row border-bottom mb-3">
         <div class="col">
	      ...
	      <!-- <span class="p-1 me-1" style="color: white; background-color: #ff6500; font-size: 0.8rem; border-radius: 0.5rem;">답변완료</span>  -->
	           <a style="font-weight: bold; font-size: 0.9rem;" >상품</a>
	         </div>
	         <div class="col-4 text-end text-secondary" style="font-size: 0.8rem; align-self: center;">2022.08.09.</div>
	       </div>
	       
	       <div class="row mb-2">
	         <div class="col" style="color:#ff6500; font-weight: bold;">
	           <i class="bi bi-quora me-1"></i>결제 되었다고 하는데</div>
	       </div>
	  
	       <div class="row mb-2">
	         <div class="col" style="font-weight: bold; font-size: 0.9rem;">결제완료 창은 떴는데 결제완료 처리가 되지 않았습니다.</div>
	       </div>
		  ...
		  <!-- <div class="row cardAnswer p-3 mb-3"  style="background-color: #F7F9FA">
		    <div class="col">
		      ...
		      <div class="row">
		        <div class="col text-secondary px-0" style="font-size: 0.9rem;"></div>
		      </div>
		    </div>
		  </div>-->
...
<!-- 나의 문의 내역 -->
         ...
         <div class="col">
	      ...
	      <span class="p-1 me-1" style="color: white; background-color: #ff6500; font-size: 0.7rem; border-radius: 0.5rem;">답변완료</span>
	           <a style="font-weight: bold; font-size: 0.9rem;" >배송</a>
	         </div>
	         <div class="col-4 text-end text-secondary" style="font-size: 0.8rem; align-self: center;">2022.08.09.</div>
	       </div>
	       ...
	       <div class="row mb-2">
	         <div class="col" style="color:#ff6500; font-weight: bold;">
	           <i class="bi bi-quora me-1"></i>언제 오나요?</div>
	       </div>
	  
	       <div class="row mb-2">
	         <div class="col" style="font-weight: bold; font-size: 0.9rem;">3일 전에 주문 했는데 배송이 오지 않았습니다. 확인 바랍니다.</div>
	       </div>
	  
		  <div class="row cardAnswer p-3 mb-2"  style="background-color: #F7F9FA">
		    <div class="col">
		      <div class="row mb-2">
		        <div class="col px-0" style="font-size: 0.9rem;">안녕하세요. 관리자입니다. 확인 결과 오늘중 배송예정으로 확인 되었습니다. 감사합니다.</div>
		      </div>
		      <div class="row">
		        <div class="col text-secondary px-0" style="font-size: 0.8rem;">2022.08.09</div>
		      </div>
		    </div>
		  </div>
